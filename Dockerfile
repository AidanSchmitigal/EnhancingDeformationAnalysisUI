...
RUN wget -q --no-check-certificate https://storage.googleapis.com/tensorflow/versions/2.18.0/libtensorflow-cpu-linux-x86_64.tar.gz && tar -C /usr/local -xzf libtensorflow-cpu-linux-x86_64.tar.gz && ldconfig /usr/local/ && echo "hi"
WORKDIR /
