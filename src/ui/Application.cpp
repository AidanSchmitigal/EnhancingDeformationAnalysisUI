...
Application::Application()
    : m_window(nullptr), m_showWelcome(true), m_assetsFound(false), m_dockspaceID(0)
{
}
...
void Application::RenderWelcomeScreen()
{
    ...
    ImGui::Bullet(); ImGui::TextWrapped("PyTorch support for AI models");
#endif
#ifdef UI_INCLUDE_TENSORFLOW
    ImGui::Bullet(); ImGui::TextWrapped("TensorFlow support for AI models");
#endif
#ifndef UI_RELEASE
    ImGui::Bullet(); ImGui::TextColored(ImVec4(0.8f, 0.5f, 0.5f, 1.0f), "Debug build with additional features!");
#endif
